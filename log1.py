...
class Bill_App:
    def __init__(self, root):
        ...
        title = Label(self.root, text="Billing Software", bd=12, relief=GROOVE, bg=bg_color, fg="white",
                      font=("time new roman", 30, "bold"), pady=2).pack(fill=X)
        ...
        self.sugar=IntVar()
        self.tea=IntVar()
        ######## cold drink #############Coca-ColaMazaFrootiLimcaSpriteMountain Dew
        self.coca=IntVar()
        self.maza=IntVar()
        self.frooti=IntVar()
        self.limca=IntVar()
        ...
        F1 = LabelFrame(self.root, text="Customer Details", bd=12, relief=GROOVE, font=("times new roman", 15, "bold"),
                        fg="gold", bg=bg_color)
        ...
        F2 = LabelFrame(self.root, text="Cosmetics", bd=12, relief=GROOVE, font=("times new roman", 15, "bold"),
                        fg="gold", bg=bg_color)
        ...
        Face_wash_txt = Entry(F2, width=10,textvariable=self.face_wash, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=2,
                                                                                                            column=1,padx=10,pady=10)
        ...
        Hair_gel_txt = Entry(F2, width=10,textvariable=self.gell, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=3,
                                                                                                           column=1,padx=10,pady=10)

        Hair_s_lbl = Label(F2, text="Hair S", font=("times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(
            row=4, column=0, padx=10, pady=10, sticky="w")
        Hair_s_txt = Entry(F2, width=10,textvariable=self.spray, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=4,
                                                                                                         column=1,padx=10,pady=10)
        ...
        F3 = LabelFrame(self.root, text="Grocery", bd=12, relief=GROOVE, font=("times new roman", 15, "bold"),
                        fg="gold", bg=bg_color)
        ...
        g2_lbl = Label(F3, text="Daal", font=("times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        g2_txt = Entry(F3, width=10,textvariable=self.daal, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=1, column=1,padx=10, pady=10)

        g3_lbl = Label(F3, text="Food Oil", font=("times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        g3_txt = Entry(F3, width=10,textvariable=self.food_oil, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=2, column=1,padx=10, pady=10)
        ...
        F4 = LabelFrame(self.root, text="Cold Drink", bd=12, relief=GROOVE, font=("times new roman", 15, "bold"),fg="gold", bg=bg_color)
        F4.place(x=670, y=180, width=325, height=380)

        d1_lbl = Label(F4, text="Coca-Cola", font=("times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(row=0, column=0, padx=10, pady=10, sticky="w")
        d1_txt = Entry(F4, width=10,textvariable=self.coca, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=0, column=1,padx=10, pady=10)

        d2_lbl = Label(F4, text="Maza", font=("times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(row=1,column=0,padx=10,pady=10,sticky="w")
        d2_txt = Entry(F4, width=10,textvariable=self.maza, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=1,column=1,padx=10, pady=10)

        d3_lbl = Label(F4, text="Frooti", font=("times new roman", 16, "bold"), bg=bg_color, fg="lightgreen").grid(row=2, column=0, padx=10, pady=10, sticky="w")
        ...
        d4_txt = Entry(F4, width=10,textvariable=self.limca, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=3, column=1,padx=10, pady=10)
        ...
        d5_txt = Entry(F4, width=10,textvariable=self.sprite, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=4, column=1,padx=10, pady=10)

        d6_lbl = Label(F4, text="Mountain Dew", font=("times new roman", 16, "bold"), bg=bg_color,fg="lightgreen").grid(row=5, column=0, padx=10, pady=10, sticky="w")
        d6_txt = Entry(F4, width=10,textvariable=self.mountaindew, font=("times new roman", 16, "bold"), bd=5, relief=SUNKEN).grid(row=5, column=1,padx=10, pady=10)
        ...
        F6 = LabelFrame(self.root, text="Bill Menu", bd=12, relief=GROOVE, font=("times new roman", 15, "bold"),
                        fg="gold", bg=bg_color)
        ...
        t1_lbl = Label(F6, text="Cosmetic Tax", bg=bg_color, fg="white", font=("times new roman", 14, "bold")).grid(
        ...
        t2_lbl = Label(F6, text="Grocery Tax", bg=bg_color, fg="white", font=("times new roman", 14, "bold")).grid(
        ...
        t3_lbl = Label(F6, text="Cold Drinks Tax", bg=bg_color, fg="white", font=("times new roman", 14, "bold")).grid(
        ...
        GBill_btn = Button(btn_F, text="Generate Bill",command=self.bill_area, bg="cadetblue", fg="white", bd=2, pady=10, width=11,
    ...
    def total(self):
        ...
        self.total_cosmetic_price=str(float
                                        (self.c_s_p+
                                        self.c_fc_p+
                                        self.c_fw_p+
                                        self.c_hs_p+
        ...
        self.total_grocery_price=str(float
                                        (self.g_r_p+
                                        self.g_f_p+
                                        self.g_d_p+
                                        self.g_w_p+
    ...
    def bill_area(self):
        ...
        if self.mountaindew.get()!=0:
            self.txtarea.insert(END,f"\n Mountain Dew\t\t{self.mountaindew.get()}\t\t{self.d_m_p}")
        ...
        if self.cold_drink_tax.get()!="Rs. 0.0":
            self.txtarea.insert(END,f"\n Cold Drink Tax\t\t\t Rs. {self.cold_drink_tax.get()}")
